/* Вырезано скриптом из src/design/ported/states.tsx — дословно, строка в строку.
 * Ни один цвет, размер, радиус или отбивка не тронуты: это те же карточки,
 * что в хендоффе, просто вынутые из сетки repeat(3,382px) поодиночке.
 * Пояснения к состояниям живут в page.tsx, здесь только разметка.
 */
/* eslint-disable @next/next/no-img-element, react/no-unknown-property */
import type { ReactElement } from 'react';
import { ImageSlot } from '@/design/ImageSlot';

/** Инбокс без обращений */
export function Specimen01(): ReactElement {
  return (
    <>
...
/** Точка в первый день */
export function Specimen02(): ReactElement {
  return (
    <>
    <div style={{ background: "#FFFFFF", borderRadius: "26px", padding: "22px", display: "flex", flexDirection: "column", gap: "16px", minHeight: "280px" }}>
...
/** Сводка владельца без сделок */
export function Specimen03(): ReactElement {
  return (
    <>
    <div style={{ background: "#FFFFFF", borderRadius: "26px", padding: "22px", display: "flex", flexDirection: "column", gap: "16px", minHeight: "280px" }}>
...
/** Панель сети до пилота */
export function Specimen04(): ReactElement {
  return (
    <>
    <div style={{ background: "#FFFFFF", borderRadius: "26px", padding: "22px", display: "flex", flexDirection: "column", gap: "16px", minHeight: "280px" }}>
...
/** Гараж до загрузки фото · Г-1 */
export function Specimen05(): ReactElement {
  return (
    <>
    <div style={{ background: "#FFFFFF", borderRadius: "26px", padding: "22px", display: "flex", flexDirection: "column", gap: "16px", minHeight: "280px" }}>
...
/** Не уложились в три минуты · М-2 */
export function Specimen06(): ReactElement {
  return (
    <>
...
/** Типовой кузов до фото · О-1 */
export function Specimen07(): ReactElement {
  return (
    <>
    <div style={{ background: "#FFFFFF", borderRadius: "26px", padding: "22px", display: "flex", flexDirection: "column", gap: "14px", minHeight: "250px" }}>
...
/** Апгрейд после прихода фото */
export function Specimen08(): ReactElement {
  return (
    <>
    <div style={{ background: "#FFFFFF", borderRadius: "26px", padding: "22px", display: "flex", flexDirection: "column", gap: "14px", minHeight: "250px" }}>
...
/** Подключён один канал из трёх */
export function Specimen09(): ReactElement {
  return (
    <>
    <div style={{ background: "#FFFFFF", borderRadius: "26px", padding: "22px", display: "flex", flexDirection: "column", gap: "14px", minHeight: "250px" }}>
...
/** Гараж после исчерпания лимита · Г-9 */
export function Specimen10(): ReactElement {
  return (
    <>
    <div style={{ background: "#FFFFFF", borderRadius: "26px", padding: "22px", display: "flex", flexDirection: "column", gap: "14px", minHeight: "250px" }}>
...
/** Медленная сеть и модель недоступна · Г-10 */
export function Specimen11(): ReactElement {
  return (
    <>
    <div style={{ background: "#FFFFFF", borderRadius: "26px", padding: "22px", display: "flex", flexDirection: "column", gap: "14px", minHeight: "250px" }}>
...
/** Непригодное фото */
export function Specimen12(): ReactElement {
  return (
    <>
...
/** Это не автомобиль · фото из объявления */
export function Specimen13(): ReactElement {
  return (
    <>
    <div style={{ background: "#FFFFFF", borderRadius: "26px", padding: "22px", display: "flex", flexDirection: "column", gap: "14px", minHeight: "236px" }}>
...
/** Артикула нет в прайсе точки · К-2 */
export function Specimen14(): ReactElement {
  return (
    <>
    <div style={{ background: "#FFFFFF", borderRadius: "26px", padding: "22px", display: "flex", flexDirection: "column", gap: "14px", minHeight: "236px" }}>
...
/** Артикула нет на складе */
export function Specimen15(): ReactElement {
  return (
    <>
    <div style={{ background: "#FFFFFF", borderRadius: "26px", padding: "22px", display: "flex", flexDirection: "column", gap: "14px", minHeight: "236px" }}>
...
/** Артикул не сошёлся с рулоном · МС-3 */
export function Specimen16(): ReactElement {
  return (
    <>
    <div style={{ background: "#FFFFFF", borderRadius: "26px", padding: "22px", display: "flex", flexDirection: "column", gap: "14px", minHeight: "236px" }}>
...
/** Не доставлено · ограничение канала */
export function Specimen17(): ReactElement {
  return (
    <>
    <div style={{ background: "#FFFFFF", borderRadius: "26px", padding: "22px", display: "flex", flexDirection: "column", gap: "14px", minHeight: "236px" }}>
...
/** Канал требует повторной привязки */
export function Specimen18(): ReactElement {
  return (
    <>
    <div style={{ background: "#FFFFFF", borderRadius: "26px", padding: "22px", display: "flex", flexDirection: "column", gap: "14px", minHeight: "236px" }}>
...
export function Specimen19(): ReactElement {
  return (
    <>
    <div style={{ background: "#FFFFFF", borderRadius: "26px", padding: "22px", display: "flex", flexDirection: "column", gap: "14px", minHeight: "236px" }}>
...
/** Фото уже оклеенной машины · §4.14 */
export function Specimen20(): ReactElement {
  return (
    <>
    <div style={{ background: "#FFFFFF", borderRadius: "26px", padding: "22px", display: "flex", flexDirection: "column", gap: "14px", minHeight: "236px" }}>
...
/** Два менеджера в одном диалоге */
export function Specimen21(): ReactElement {
  return (
    <>
...
/** Клиент и менеджер меняют конфигурацию разом */
export function Specimen22(): ReactElement {
  return (
    <>
    <div style={{ background: "#FFFFFF", borderRadius: "26px", padding: "22px", display: "flex", flexDirection: "column", gap: "14px", minHeight: "230px" }}>
...
/** Счётчик генераций у лимита */
export function Specimen23(): ReactElement {
  return (
    <>
    <div style={{ background: "#FFFFFF", borderRadius: "26px", padding: "22px", display: "flex", flexDirection: "column", gap: "14px", minHeight: "230px" }}>
...
/** Точка без первой отправки · 24 / 48 / 72 ч */
export function Specimen24(): ReactElement {
  return (
    <>
    <div style={{ background: "#FFFFFF", borderRadius: "26px", padding: "22px", display: "flex", flexDirection: "column", gap: "14px", minHeight: "230px" }}>
...
/** Незавершённая примерка */
export function Specimen25(): ReactElement {
  return (
    <>
    <div style={{ background: "#FFFFFF", borderRadius: "26px", padding: "22px", display: "flex", flexDirection: "column", gap: "14px", minHeight: "230px" }}>
...
/** Правило системы */
export function Specimen26(): ReactElement {
  return (
    <>
    <div style={{ background: "#FFFFFF", borderRadius: "26px", padding: "22px", display: "flex", flexDirection: "column", gap: "14px", minHeight: "230px" }}>
...
export const SPECIMENS: (() => ReactElement)[] = [
  Specimen01, Specimen02, Specimen03, Specimen04, Specimen05, Specimen06,
  Specimen07, Specimen08, Specimen09, Specimen10, Specimen11, Specimen12,
  Specimen13, Specimen14, Specimen15, Specimen16, Specimen17, Specimen18,
  Specimen19, Specimen20, Specimen21, Specimen22, Specimen23, Specimen24,
  Specimen25, Specimen26,
];
