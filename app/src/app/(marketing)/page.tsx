...
export const metadata: Metadata = {
  // absolute: шаблон корневой разметки дописывает «· YOOMP» к заголовку
  // страницы, а этот его уже содержит — получалось «YOOMP — … · YOOMP».
  title: { absolute: 'YOOMP — примерочная плёнок для детейлинг-студий' },
  description:
